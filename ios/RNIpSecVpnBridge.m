...
RCT_EXTERN_METHOD(getShadowServerString:()
RCT_EXTERN_METHOD(saveShadowServerString:(NSString *)text findEventsWithResolver:(RCTPromiseResolveBlock)findEventsWithResolver rejecter:(RCTPromiseRejectBlock)rejecter)
